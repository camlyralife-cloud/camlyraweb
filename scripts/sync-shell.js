            ...
            <div class="nav-container">
                ...
                <div class="nav-menu" id="nav-menu">
                    ...
                    <div class="nav-mega-wrap">
                        ...
                        <div class="mega-panel" id="mega-services-panel" role="navigation" aria-label="Services menu" hidden>
                            <div class="mega-panel-inner mega-layout-grouped">
                                <div class="mega-group">
                                    <p class="mega-group-title">Clinical Therapy</p>
                                ...
                                <div class="mega-group">
                                    ...
                                    <nav class="mega-group-nav" aria-label="Specialist care">
                                        ...
                                        <a class="mega-group-link mega-group-link--cta" href="{BASE}index.html#new-services">View All Services</a>
                                    </nav>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="nav-ns-wrap nav-coaching-wrap">
                        ...
                        <div class="ns-dropdown ns-dropdown--wide" id="coaching-dropdown-panel" role="navigation" aria-label="Coaching menu" hidden>
                            ...
                            <a class="ns-dropdown-link" href="{BASE}services/career/Executivecoaching.html">Leadership Psychology</a>
                            <a class="ns-dropdown-link" href="{BASE}services/career/Productivity.html">High-Performance Coaching</a>
                            <a class="ns-dropdown-link ns-dropdown-link--cta" href="{BASE}index.html#coaching">Explore All Coaching</a>
                        </div>
                    </div>
...
const FOOTER_TEMPLATE = `<footer id="footer" class="site-footer" data-testid="site-footer">
        <div class="container footer-inner">
            <div class="footer-grid">
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-col-list">
                        ...
                        <li><a href="{BASE}services/specific-disorders/OCD.html">OCD</a></li>
                        <li><a href="{BASE}services/specific-disorders/Sleepingdisorder.html">Sleep</a></li>
                        <li><a href="{BASE}services/specific-disorders/Eatingdisorder.html">Eating Disorders</a></li>
                        <li><a href="{BASE}index.html#new-services" class="footer-link-cta">View All Services →</a></li>
                    </ul>
                </div>
                <div class="footer-col">
            ...
            <div class="footer-bottom-bar">
                <p class="footer-copyright footer-copyright--wide">Licensed by the Dubai Health Authority (DHA Licence No. [XXXXXX]) · RCI Registered (No. [XXXXXX]) · &copy; <span data-year>2026</span> Calmyra Mental Wellness. All rights reserved.</p>
            </div>
        </div>
    </footer>`;
