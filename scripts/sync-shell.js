            ...
            <div class="nav-container">
                ...
                <div class="nav-menu" id="nav-menu">
                    ...
                    <div class="nav-actions">
                        ...
                        <a href="{BASE}assets/calmyra-workbook.pdf" class="btn btn-secondary btn-nav btn-nav--workbook" download data-workbook-trigger data-testid="header-cta-workbook">
...
const FOOTER_TEMPLATE = `<footer id="footer" class="site-footer" data-testid="site-footer">
        <div class="container footer-inner">
            ...
            <div class="footer-bottom-bar">
                ...
                <p class="footer-credit">Designed &amp; Developed by <a href="https://maheenkehkasha.netlify.app/" target="_blank" rel="noopener noreferrer">Maheen Kehkasha</a></p>
            </div>
        </div>
    </footer>`;
