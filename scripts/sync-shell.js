            ...
            <div class="nav-container">
                ...
                <div class="nav-menu" id="nav-menu">
                        ...
                        <div class="ns-dropdown ns-dropdown--personas" id="coaching-dropdown-panel" role="navigation" aria-label="Dubai coaching and consulting services" hidden>
                            ...
                            <div class="ns-dropdown-cols">
                                <div class="ns-dropdown-col">
                                    ...
                                    <a class="ns-dropdown-link" href="{BASE}services/coaching/life-coaching.html#families">For Parents &amp; Families</a>
                    ...
                    <div class="nav-actions">
                        <a href="{BASE}index.html#get-started" class="btn btn-secondary btn-nav btn-nav--book" data-testid="header-cta-book">Book an Appointment</a>
                        <a href="{BASE}assets/downloads/calmyra-workbook.pdf" class="btn btn-primary btn-nav btn-nav--workbook" download data-testid="header-cta-workbook">
        ...
        <div class="container footer-inner">
            <div class="footer-grid">
                <div class="footer-col footer-brand" id="locations">
                    ...
                    <a href="{BASE}index.html#get-started" class="btn btn-primary footer-cta">Book an Appointment</a>
                ...
                <div class="footer-col">
                    ...
                    <ul class="footer-col-list">
                        ...
                        <li><a href="{BASE}index.html#get-started">Online Sessions</a></li>
                    </ul>
                </div>
                <div class="footer-col">
